    ...
    def test_builds_zero_metrics_when_files_is_None(self):
        ...
        self.assertSiaStateEqual(
            state.SiaState(
                ...
                file_count=0,
                file_total_bytes=0,
                file_uploads_in_progress_count=0,
                file_uploaded_bytes=0,
                contract_count_active=None,
                contract_count_inactive=None,
                contract_total_size=None,
                contract_total_spending=None,
                contract_fee_spending=None,
                contract_storage_spending=None,
                contract_upload_spending=None,
                contract_download_spending=None,
                contract_remaining_funds=None,
    ...
    def test_builds_partial_state_when_one_api_call_fails(self):
        ...
        self.assertSiaStateEqual(
            state.SiaState(
                ...
                file_uploads_in_progress_count=None,
                file_uploaded_bytes=None,
                contract_count_active=2,
                contract_count_inactive=2,
                contract_total_size=143L,
                contract_total_spending=1050000L,
